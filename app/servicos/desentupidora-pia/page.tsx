...
export default function DesentupidoraPia() {
    ...
    <main className="min-h-screen bg-white">
      <section className="py-12 px-4 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-4">Desentupir Pia em Curitiba | Desentupidora de Pia 24h</h1>
          <p className="text-lg text-gray-600 mb-8">Pia da Cozinha Entupida? Removemos Gordura e Restos em Curitiba!</p>
      ...
      <section className="py-12 px-4 bg-gray-50">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Serviços de Desentupimento de Pia em Curitiba</h2>
          <div className="space-y-4">
            ...
            <div className="bg-white p-4 rounded-lg shadow-sm">
              <h3 className="font-bold text-gray-900 mb-2">Desentupimento de Pia de Banheiro</h3>
              <p className="text-gray-600">Desobstruímos pias de banheiro com rapidez e sem sujeira.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-4 bg-white">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Por Que Escolher Nossa Desentupidora de Pia?</h2>
          <ul className="space-y-4">
            <li className="flex items-start gap-3"><span className="text-green-600 text-xl">✓</span><span className="text-gray-700">Serviço rápido e limpo</span></li>
      ...
      <section className="py-12 px-4 bg-gradient-to-b from-gray-50 to-white">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">Pia Entupida? Solicite Agora</h2>
