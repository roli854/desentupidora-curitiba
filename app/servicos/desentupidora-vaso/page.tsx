...
export const metadata: Metadata = { 
  title: 'Desentupidora de Vaso Sanitário em Curitiba | Atendimento 24h', 
  description: 'Desentupimento de vaso sanitario em Curitiba. Removemos objetos, papel e qualquer obstrução. Orçamento gratuito!' 
}

const PHONE = '5596984321456'
const WA_LINK = `https://wa.me/${PHONE}?text=Ola%2C%20preciso%20desentupir%20um%20vaso%20sanitario`
  ...
  return (
    <main className="min-h-screen bg-[#f8f9fb] text-[#191c1e]">
      ...
      <section className="relative min-h-[500px] flex items-center justify-center py-10 md:py-20 overflow-hidden">
        <div className="absolute inset-0 z-0"><img alt="Desentupidora de Vaso" src="/images/plumber.jpg" className="w-full h-full object-cover" /><div className="absolute inset-0 bg-[#1a365d]/85"></div></div>
        <div className="relative z-10 w-full max-w-6xl mx-auto px-6 text-center md:text-left">
          ...
          <h1 className="text-3xl md:text-5xl font-extrabold text-white mb-4">Desentupidora de Vaso em Curitiba</h1>
          <p className="text-lg text-white opacity-90 mb-8 max-w-[600px]">Desentupimento de vaso sanitario. Removemos objetos, papel e qualquer obstrução sem quebrar o vaso.</p>
