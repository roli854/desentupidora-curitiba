...
const faqs = [
  ...
  { q: 'Quanto tempo demora o serviço?', a: 'Em média, um desentupimento de vaso comum leva de 20 a 40 minutos para ser totally concluído após a chegada do técnico.' },
]
      ...
      <section className="py-10 md:py-20 max-w-6xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
          <div className="md:col-span-8 bg-white border border-[#c4c6cf] p-8">
            <h2 className="text-2xl font-bold text-[#1a365d] mb-4">Por que seu vaso entupiu?</h2>
...
<section className="py-12 px-4 bg-white">
      ...
      <section className="py-10 md:py-20 bg-white border-t border-[#c4c6cf]">
        <div className="max-w-6xl mx-auto px-6 text-center">
          <h2 className="text-2xl font-bold text-[#1a365d] mb-6">Vaso entupido não pode esperar</h2>
          ...
          <div className="flex flex-col md:flex-row justify-center gap-4">
            ...
            <a className="bg-[#1a365d] text-white px-12 h-16 flex items-center justify-center text-lg font-bold rounded-lg hover:bg-[#1a365d] transition-all shadow-md" href={`tel:${PHONE}`}>LIGAR AGORA</a>
          </div>
        </div>
      </section>
