...
export const metadata: Metadata = { 
  ...
  description: 'Desentupimento de ralo de chão, banheiro e cozinha em Curitiba. Removemos sujeira, gordura e raízes. Orçamento gratuito!' 
}
  ...
  return (
    <main className="min-h-screen bg-[#f8f9fb] text-[#191c1e]">
      ...
      <section className="relative min-h-[500px] flex items-center justify-center py-10 md:py-20 overflow-hidden">
        <div className="absolute inset-0 z-0"><img alt="Desentupidora de Ralo" src="/images/plumber.jpg" className="w-full h-full object-cover" /><div className="absolute inset-0 bg-[#1a365d]/85"></div></div>
        <div className="relative z-10 w-full max-w-6xl mx-auto px-6 text-center md:text-left">
          ...
          <h1 className="text-3xl md:text-5xl font-extrabold text-white mb-4">Desentupidora de Ralo em Curitiba</h1>
          <p className="text-lg text-white opacity-90 mb-8 max-w-[600px]">Desentupimento de ralo de chão, banheiro e cozinha. Removemos sujeira acumulada e raízes.</p>
