...
export const metadata: Metadata = {
  title: 'Desentupidora de Esgoto 24h Curitiba - Serviço Completo | Orçamento Grátis',
  description: 'Problema de esgoto em Curitiba? Nós resolvemos! Desentupimento completo de rede de esgoto residencial e comercial. Diagnóstico profissional.',
}

const WA_LINK = 'https://wa.me/5541999999999?text=Ola%2C%20preciso%20desentupir%20esgoto'
const TEL = 'tel:+5541999999999'

const services = [
  'Desentupimento de rede residencial',
  'Desentupimento de rede comercial',
  'Inspeção e diagnóstico',
  'Remoção de raízes e calcificações',
  'Limpeza de fossa e sumidouro',
    ...
    <main className="min-h-screen bg-[#f8f9fb] text-[#191c1e]">
      ...
      <section className="relative bg-[#1a365d] text-white py-16 md:py-20 overflow-hidden">
        <div className="absolute inset-0 z-0 opacity-[0.12]">
          <img src="/images/plumber.jpg" alt="Desentupidora Esgoto Curitiba" className="w-full h-full object-cover" />
        </div>
        <div className="relative z-10 max-w-6xl mx-auto px-4">
          ...
          <h1 className="text-2xl md:text-4xl font-extrabold mb-4">
            Problema de Esgoto em Curitiba? Chegamos em 30 Minutos!
          </h1>
          <p className="text-lg md:text-xl mb-8 opacity-90">
            Desentupimento completo de rede de esgoto residencial e comercial em Curitiba. Diagnóstico profissional, solução definitiva e atendimento 24 horas. Orçamento Grátis!
          </p>
      ...
      <section className="py-12 md:py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-xl md:text-2xl font-bold mb-8">O Que Fazemos</h2>
          <div className="grid md:grid-cols-2 gap-4">
            {services.map((service, i) => (
              <div key={i} className="flex items-start gap-3 p-4 border border-[#c4c6cf] rounded">
                ...
                <span className="text-[#43474e]">{service}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-12 md:py-16 bg-[#f8f9fb]">
        <div className="max-w-6xl mx-auto px-4 text-center">
          <h2 className="text-xl md:text-2xl font-bold mb-8">Atendemos Curitiba e Região</h2>
          <p className="text-[#43474e] mb-4">Curitiba, Pinhais, São José Pinhais, Araucária, Fazenda Rio Grande, Campina Grande Sul, Colombo, Piraquara</p>
